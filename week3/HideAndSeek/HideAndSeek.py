...
def Setup():
    ...
    d["count"]=0
    d["lab{0}".format(0)] = Label(root,text="Hide and Seek",bd=20,highlightthickness=2)
    ...
    d["ent{0}".format(0)] = Text(root,highlightthickness=2,width=10,height=5)
    ...
    d["but{0}".format(0)]= Button(root,text="Make Guess",padx=20,command= lambda nums=0: Player.Guess(num,d))
